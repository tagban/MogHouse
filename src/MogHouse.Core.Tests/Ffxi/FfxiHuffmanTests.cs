...
/// MogHouse deliberately doesn't ship them - see FfxiHuffmanTables. A skip
/// says "not verified here" honestly; a silent pass would claim verification
/// that never happened. Set MOGHOUSE_FFXI_RES to a directory holding both
/// files to run them.
/// </summary>
public class FfxiHuffmanTests
{
    ...
    private static FfxiHuffman RequireCodec()
    {
        ...
        Skip.If(tables is null,
            "FFXI compression tables not installed. Set MOGHOUSE_FFXI_RES to a directory containing " +
