// Implementation of the C ABI declared in portjeuno_interop.h.
//
...
class PortJeunoGame : public FFXIGame
{
public:
    explicit PortJeunoGame(const lotus::Settings& settings) : FFXIGame(settings) {}
...
extern "C"
{
    ...
    {
        return new PjGame(app_name ? std::string(app_name) : std::string("PortJeuno"), app_version);
    }
