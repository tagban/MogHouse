...
// PATCHED: every vulkan_*.hpp skips its standard includes when built as a
// module (`#if !defined( VULKAN_HPP_CXX_MODULE )`) and relies on `import std`.
// Including them here in the global module fragment removes the only
// dependency this project has on the standard library module.
#include <algorithm>
#include <array>
#include <atomic>
#include <cassert>
...
// PATCHED: removed `export import std;`
